...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 28, fontWeight: "800", color: "#1e293b", marginBottom: 25, letterSpacing: -0.5 },
    profileCard: {
        alignItems: "center", backgroundColor: "#fff", borderRadius: 24,
        padding: 30, marginBottom: 30, elevation: 2,
        shadowColor: "#000", shadowOffset: { width: 0, height: 10 },
        shadowOpacity: 0.05, shadowRadius: 20,
    },
    avatarGradient: {
        width: 90, height: 90, borderRadius: 30, backgroundColor: "#6366f1",
    ...
    statusBadge: {
        ...
        borderRadius: 12, marginTop: 10, borderWidth: 1, borderColor: "#dcfce7",
    },
    statusText: { color: "#16a34a", fontSize: 12, fontWeight: "700", letterSpacing: 0.5 },
    ...
    detailsCard: {
        ...
        paddingHorizontal: 16, elevation: 1,
    },
    ...
    logoutButton: {
        flexDirection: "row", backgroundColor: "#fee2e2", paddingVertical: 16,
        borderRadius: 16, justifyContent: "center", alignItems: "center", marginTop: 10,
    },
