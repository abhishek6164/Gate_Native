...
import { logVisitorEntry } from "../../services/authApi";
...
export default function EntryFormScreen({ navigation }) {
    ...
    const [formData, setFormData] = useState({
        name: "", mobile: "", deliveryPartner: "", building: "", flat: ""
    });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result.preApproved) {
                Alert.alert("✅ Pre-Approved!", `Entry logged for ${formData.name}. Welcome!`);
            } else {
                Alert.alert("✅ Entry Logged", `${formData.name} entry has been recorded.`);
            }
...
const styles = StyleSheet.create({
    ...
    permBtn: { backgroundColor: "#6366f1", padding: 12, borderRadius: 10, marginTop: 10 },
    header: { padding: 20 },
    ...
    input: {
        ...
        borderWidth: 1, borderColor: "#e2e8f0", fontSize: 16, marginBottom: 12
    },
